...
class BsmModel:
    ...
    def delta(self, strike, spot, texp, cp_sign=1):
        ...
        result = ss.norm.cdf(d1) - 0.5 * (1 - cp_sign)
        return result
    ...
    def vega(self, strike, spot, vol, texp, cp_sign=1):
        ...
        result = spot * np.sqrt(texp) * ss.norm.pdf(d1)
        return result
